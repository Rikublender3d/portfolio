    ...
    <div className="relative">
      ...
      <div className="mx-auto text-center fade-up" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div className="max-w-5xl mx-auto mt-10 md:flex items-center justify-between gap-6 column-3 fade-up" data-aos="fade-up" data-aos-duration="1000">
          <img src={Image} alt="Profile" className="px-5 rounded-full md:w-1/2 md:h-1/2 object-covers" />
        ...
        <div className="w-100 max-w-6xl mx-auto mt-10 md:flex items-center md:justify-evenly md:columns-3 column-1">
          <div class="my-2 md:w-[30%] max-w-sm mx-auto rounded overflow-hidden shadow-lg flip-up" data-aos="flip-up" data-aos-duration="500">
          ...
          <div class="my-2 md:w-[30%] mx-auto max-w-sm rounded overflow-hidden shadow-lg flip-up" data-aos="flip-up" data-aos-duration="1000">
          ...
          <div class="my-2 md:w-[30%] mx-auto max-w-sm rounded overflow-hidden shadow-lg flip-up" data-aos="flip-up" data-aos-duration="1500">
        ...
        <div className="max-w-5xl mx-auto my-10 md:flex items-center justify-between gap-6 column-3 fade-up" data-aos="fade-up" data-aos-duration="1000">
          <img src={Works} alt="Profile" className="md:w-1/2 h-1/2" />
          <div className="md:text-left md:w-1/2">
